            ...
            <div className="container">
              ...
              <div className={`collapse navbar-collapse ${this.state.navStatus ? 'show' : ''}`} id="header-nav">
                <ul className="navbar-nav ml-auto">
                  <li className="nav-item nav-link active" onClick={this.navigate} id='home'><a href='/' className='text-decoration-none'>Home</a></li>
                  <li className="nav-item nav-link" onClick={this.navigate} id='shop'><a href='/shop' className='text-decoration-none'>Shop</a></li>
                  <li className="nav-item nav-link" onClick={this.navigate} id='about'><a href='/about' className='text-decoration-none'>About</a></li>
                  <li className="nav-item nav-link" onClick={this.navigate} id='contact'><a href='/contact' className='text-decoration-none'>Contact</a></li>
                  <li className="nav-item nav-link" onClick={this.navigate} id='cart'><a href='/cart' className='text-decoration-none'><i className='bx bxs-cart bx-xs'></i>[0]</a></li>
                </ul>
              </div>
            </div>
          </nav>
